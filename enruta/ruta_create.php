      ...
      <td>
          <div class="container text-center ">
           ...
           if ($filas5 ['id_ruta'] === null ) {
                ?> 
                  <a href="guiasrem_create_read.php?idp=<?php echo $filas2 ['id_prog']?>&idr=<?php echo $filas2 ['id_ruta']?>" class="btn btn-light" > 
                    &nbsp REGISTRAR &nbsp
                  </a>
                <?php
           } else {
                ?> 
                  <a href="guiasrem_create_read.php?idp=<?php echo $filas2 ['id_prog']?>&idr=<?php echo $filas2 ['id_ruta']?>" class="btn btn-primary"> 
                    &nbsp REGISTRAR &nbsp
                  </a>
                <?php
