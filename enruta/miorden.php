...
SELECT miorden.*, miorden.id_conductor, miorden.id_ayudante
FROM miorden
WHERE (((miorden.id_conductor)=$id_userup)) OR (((miorden.id_ayudante)=$id_userup));
...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link active" href="miorden.php">ACTIVAS</a>
  </li>
  <li class="nav-item">
