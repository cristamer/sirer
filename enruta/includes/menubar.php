...
<nav class="navbar navbar-expand-lg navbar-dark " style="background-color: #434343;">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="miorden.php">ORDENES DE TRABAJO</a>
      </li>

      <li class="nav-item active">
        <a class="nav-link" href="rendiciones.php">RENDICIONES</a>
      </li>
