...
$c17 = $filas['user_salario'];
$c18 = $filas['user_hingreso'];

?>

 <form  action="crud_user/update2.php" method="POST" enctype="multipart/form-data" class="colm">
...
<h4> MI PERFIL </h4>
  <div class="row" >
    ...
    <input class="form-control"  type="hidden" id="id_user" name="id_user" value="<?php echo $id ; ?> " readonly>
	  <div class="form-group " >
	  ...
	  <div class="form-group " >
	    ...
	    <input class="form-control" type="number" placeholder="corporativo@mail.com" id="user_salario" name="user_salario" value="<?php echo $c17; ?>">
	    <small id="Help" class="form-text text-muted">Ingrese su SALARIO.</small>
	  </div>
	  	  <div class="form-group " >
	    <label for="user_hingreso">ASISTENCIA  </label>
	    <input class="form-control" type="time" placeholder="corporativo@mail.com" id="user_hingreso" name="user_hingreso" value="<?php echo $c18; ?>">
	    <small id="Help" class="form-text text-muted">Ingrese su HORA DE INGRESO.</small>
	  </div>
